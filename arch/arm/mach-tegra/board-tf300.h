/*
 * arch/arm/mach-tegra/board-tf300.h
 *
...
int tf300_charge_init(void);
int tf300_regulator_init(void);
int tf300_suspend_init(void);
int tf300_sdhci_init(void);
int tf300_pinmux_init(void);
int tf300_panel_init(void);
int tf300_sensors_init(void);
int tf300_keys_init(void);
int tf300_pins_state_init(void);
int tf300_emc_init(void);
int tf300_edp_init(void);
int tf300_pmon_init(void);
int tf300_pm298_gpio_switch_regulator_init(void);
int tf300_pm298_regulator_init(void);
int tf300_pm299_gpio_switch_regulator_init(void);
int tf300_pm299_regulator_init(void);
