...
static __initdata struct tegra_pingroup_config tf201_pinmux_pm311[] = {
	/* Power rails GPIO */
	DEFAULT_PINMUX(SPI2_SCK,        SPI2,            NORMAL,    NORMAL,     INPUT),
...
static __initdata struct tegra_pingroup_config tf201_pinmux_tf201[] = {
	DEFAULT_PINMUX(LCD_CS0_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
...
static __initdata struct tegra_pingroup_config tf201_pinmux_tf201_a03[] = {
	DEFAULT_PINMUX(LCD_CS0_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_SCK,         DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_CS1_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_M1,          DISPLAYA,        NORMAL,    NORMAL,     INPUT),
...
static __initdata struct tegra_pingroup_config tf201_pinmux_e1291_a04[] = {
	DEFAULT_PINMUX(GMI_AD15,        NAND,            PULL_DOWN,   NORMAL,   OUTPUT),
...
static __initdata struct tegra_pingroup_config tf201_pinmux_e1198[] = {
	DEFAULT_PINMUX(LCD_CS0_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_SCK,         DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_CS1_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_M1,          DISPLAYA,        NORMAL,    NORMAL,     INPUT),
...
static __initdata struct tegra_pingroup_config tf201_pinmux_pm269_e1506[] = {
...
int __init tf201_pinmux_init(void)
{
	...
	switch (board_info.board_id) {
	case BOARD_E1198:
		tegra_pinmux_config_table(tf201_pinmux_e1198,
					ARRAY_SIZE(tf201_pinmux_e1198));
		tegra_pinmux_config_table(unused_pins_lowpower,
					ARRAY_SIZE(unused_pins_lowpower));
		if (board_info.fab >= BOARD_FAB_A02)
			tegra_pinmux_config_table(tf201_pinmux_tf201_a03,
					ARRAY_SIZE(tf201_pinmux_tf201_a03));
		break;
	case BOARD_E1291:
		if (board_info.fab < BOARD_FAB_A03) {
			tegra_pinmux_config_table(tf201_pinmux_tf201,
					ARRAY_SIZE(tf201_pinmux_tf201));
			tegra_pinmux_config_table(unused_pins_lowpower,
					ARRAY_SIZE(unused_pins_lowpower));
		} else {
			tegra_pinmux_config_table(tf201_pinmux_tf201_a03,
		...
		if (board_info.fab >= BOARD_FAB_A04)
			tegra_pinmux_config_table(tf201_pinmux_e1291_a04,
					ARRAY_SIZE(tf201_pinmux_e1291_a04));
		break;
	...
	case BOARD_E1257:
		if (board_info.board_id == BOARD_PM311 || board_info.board_id == BOARD_PM305) {
			tegra_pinmux_config_table(tf201_pinmux_pm311,
					ARRAY_SIZE(tf201_pinmux_pm311));
		} else {
		...
		if (display_board_info.board_id == BOARD_DISPLAY_E1506) {
			tegra_pinmux_config_table(tf201_pinmux_pm269_e1506,
					ARRAY_SIZE(tf201_pinmux_pm269_e1506));
		}
...
int __init tf201_pins_state_init(void)
{
	...
	if ((board_info.board_id == BOARD_E1291) ||
		(board_info.board_id == BOARD_E1198)) {
			set_unused_pin_gpio(&pin_lpm_tf201_common[0],
					ARRAY_SIZE(pin_lpm_tf201_common));

			if (display_board_info.board_id != BOARD_DISPLAY_PM313) {
				set_unused_pin_gpio(&pin_lpm_tf201_common_wo_pm313[0],
						ARRAY_SIZE(pin_lpm_tf201_common_wo_pm313));
			}
	}
