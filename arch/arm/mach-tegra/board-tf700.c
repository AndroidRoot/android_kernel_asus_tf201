/*
 * arch/arm/mach-tegra/board-tf700.c
 *
...
static struct rfkill_gpio_platform_data tf700_bt_rfkill_pdata[] = {
	{
		.name           = "bt_rfkill",
...
static struct platform_device tf700_bt_rfkill_device = {
	.name = "rfkill_gpio",
	.id             = -1,
	.dev = {
		.platform_data = &tf700_bt_rfkill_pdata,
	},
};

static struct resource tf700_bluesleep_resources[] = {
	[0] = {
		.name = "gpio_host_wake",
...
static struct platform_device tf700_bluesleep_device = {
	.name           = "bluesleep",
	.id             = -1,
	.num_resources  = ARRAY_SIZE(tf700_bluesleep_resources),
	.resource       = tf700_bluesleep_resources,
};

static noinline void __init tf700_setup_bluesleep(void)
{
	platform_device_register(&tf700_bluesleep_device);
	return;
}

static __initdata struct tegra_clk_init_table tf700_clk_init_table[] = {
...
static struct i2c_board_info __initdata tf700_i2c_bus3_board_info[] = {
	{
...
static struct tegra_i2c_platform_data tf700_i2c1_platform_data = {
	.adapter_nr	= 0,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data tf700_i2c2_platform_data = {
	.adapter_nr	= 1,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data tf700_i2c3_platform_data = {
	.adapter_nr	= 2,
	.bus_count	= 1,
	.bus_clk_rate	= { 100000, 0 },
...
static struct tegra_i2c_platform_data tf700_i2c3_platform_data_for_TF300 = {
	.adapter_nr	= 2,
	.bus_count	= 1,
	.bus_clk_rate	= { 400000, 0 },
	.scl_gpio		= {TEGRA_GPIO_PBB1, 0},
...
static struct tegra_i2c_platform_data tf700_i2c4_platform_data = {
	.adapter_nr	= 3,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data tf700_i2c5_platform_data = {
	.adapter_nr	= 4,
	.bus_count	= 1,
	.bus_clk_rate	= { 400000, 0 },
...
static struct wm8903_platform_data tf700_wm8903_pdata = {
	.irq_active_low = 0,
	.micdet_cfg = 0,
	.micdet_delay = 100,
...
static const struct i2c_board_info tf700_dsp_board_info[] = {
	{
...
static struct i2c_board_info __initdata wm8903_board_info = {
	...
	.platform_data = &tf700_wm8903_pdata,
};
...
static struct max98095_pdata tf700_max98095_pdata = {
...
static struct i2c_board_info __initdata tf700_codec_wm8903_info = {
	I2C_BOARD_INFO("wm8903", 0x1a),
	.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
	.platform_data = &tf700_wm8903_pdata,
};

static struct i2c_board_info __initdata tf700_codec_rt5640_info[] = {
	{
		 I2C_BOARD_INFO("rt5640", 0x1c),
		.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
	},
...
static struct i2c_board_info __initdata tf700_codec_aic326x_info = {
	I2C_BOARD_INFO("aic3262-codec", 0x18),
	.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
};

static struct i2c_board_info __initdata tf700_codec_max98095_info = {
	I2C_BOARD_INFO("max98095", 0x10),
	.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
	.platform_data = &tf700_max98095_pdata,
};

static struct i2c_board_info __initdata tf700_i2c_asuspec_info[] = {
	{
...
static void tf700_i2c_init(void)
{
	u32 project_info = tegra3_get_project_id();

	tegra_i2c_device1.dev.platform_data = &tf700_i2c1_platform_data;
	tegra_i2c_device2.dev.platform_data = &tf700_i2c2_platform_data;
	...
	if ((project_info == TEGRA3_PROJECT_TF300T) ||
		...
		tegra_i2c_device3.dev.platform_data = &tf700_i2c3_platform_data_for_TF300;
	} else {
		tegra_i2c_device3.dev.platform_data = &tf700_i2c3_platform_data;
	}

	if (project_info == TEGRA3_PROJECT_P1801)
		tf700_i2c4_platform_data.bus_clk_rate[0] = 33000;

	tegra_i2c_device4.dev.platform_data = &tf700_i2c4_platform_data;
	tegra_i2c_device5.dev.platform_data = &tf700_i2c5_platform_data;
	...
	//i2c_register_board_info(4, &tf700_codec_wm8903_info, 1);
	//i2c_register_board_info(4, &tf700_codec_max98095_info, 1);
	//i2c_register_board_info(4, &tf700_codec_aic326x_info, 1);

	if(project_info != TEGRA3_PROJECT_ME301T)
	{
		i2c_register_board_info(1, tf700_i2c_asuspec_info, ARRAY_SIZE(tf700_i2c_asuspec_info));
	}
	...
	i2c_register_board_info(0, tf700_dsp_board_info, 1);
#endif
}

static struct platform_device *tf700_uart_devices[] __initdata = {
	&tegra_uartb_device,
	&tegra_uartc_device,
	&tegra_uartd_device,
	&tegra_uarte_device,
...
static struct tegra_uart_platform_data tf700_uart_pdata;
static struct tegra_uart_platform_data tf700_loopback_uart_pdata;
...
static void __init uart_debug_init(void)
{
	...
	if ((board_info.board_id == BOARD_E1186) ||
		...
		if (debug_port_id == 1) {
			tf700_irda_pdata.is_irda = false;
...
static void __init tf700_uart_init(void)
{
	struct clk *c;
	int i;
	...
	tf700_uart_pdata.parent_clk_list = uart_parent_clk;
	tf700_uart_pdata.parent_clk_count = ARRAY_SIZE(uart_parent_clk);
	tf700_loopback_uart_pdata.parent_clk_list = uart_parent_clk;
	tf700_loopback_uart_pdata.parent_clk_count =
						ARRAY_SIZE(uart_parent_clk);
	tf700_loopback_uart_pdata.is_loopback = true;
	tegra_uartb_device.dev.platform_data = &tf700_uart_pdata;
	tegra_uartc_device.dev.platform_data = &tf700_uart_pdata;
	tegra_uartd_device.dev.platform_data = &tf700_uart_pdata;
	/* UARTE is used for loopback test purpose */
	tegra_uarte_device.dev.platform_data = &tf700_loopback_uart_pdata;
	...
	if (((board_info.board_id == BOARD_E1186) ||
		(board_info.board_id == BOARD_E1198)) &&
			tf700_irda_pdata.is_irda) {
		tf700_irda_pdata.parent_clk_list = uart_parent_clk;
		tf700_irda_pdata.parent_clk_count =
					ARRAY_SIZE(uart_parent_clk);

		tegra_uartb_device.dev.platform_data = &tf700_irda_pdata;
	}
#endif

	platform_add_devices(tf700_uart_devices,
				ARRAY_SIZE(tf700_uart_devices));
}
...
static struct platform_device *tf700_spi_devices[] __initdata = {
	&tegra_spi_device4,
};
...
static struct tegra_spi_platform_data tf700_spi_pdata = {
	.is_dma_based		= true,
...
static void __init tf700_spi_init(void)
{
	int i;
	struct clk *c;
	...
	tf700_spi_pdata.parent_clk_list = spi_parent_clk;
	tf700_spi_pdata.parent_clk_count = ARRAY_SIZE(spi_parent_clk);
	tegra_spi_device4.dev.platform_data = &tf700_spi_pdata;
	platform_add_devices(tf700_spi_devices,
				ARRAY_SIZE(tf700_spi_devices));
	...
	if (board_info.board_id == BOARD_E1198) {
		tegra_spi_device2.dev.platform_data = &tf700_spi_pdata;
		platform_device_register(&tegra_spi_device2);
		tegra_spi_slave_device1.dev.platform_data = &tf700_spi_pdata;
		platform_device_register(&tegra_spi_slave_device1);
	}
}

static void __init tf700_dtv_init(void)
{
	struct board_info board_info;
...
static struct tegra_wm8903_platform_data tf700_audio_wm8903_pdata = {
...
static struct platform_device tf700_audio_device = {
	.name	= "tegra-snd-codec",
        .id     = 0,
        .dev    = {
                .platform_data = &tf700_audio_wm8903_pdata,
        },
};
static struct tegra_rt5640_platform_data tf700_audio_rt5640_pdata = {
	.gpio_spkr_en		= -1,
	.gpio_hp_det		= TEGRA_GPIO_HP_DET,
	.gpio_hp_mute		= -1,
	.gpio_int_mic_en	= -1,
...
static struct tegra_asoc_platform_data tf700_audio_max98095_pdata = {
	.gpio_spkr_en		= -1,
	.gpio_hp_det		= TEGRA_GPIO_HP_DET,
	.gpio_hp_mute		= -1,
	.gpio_int_mic_en	= -1,
...
static struct platform_device tf700_audio_wm8903_device = {
...
static struct platform_device tf700_audio_rt5640_device = {
	.name	= "tegra-snd-codec",
	.id	= 0,
	.dev	= {
		.platform_data = &tf700_audio_rt5640_pdata,
	},
};

static struct platform_device tf700_audio_max98095_device = {
	.name	= "tegra-snd-max98095",
	.id	= 0,
	.dev	= {
		.platform_data = &tf700_audio_max98095_pdata,
	},
};

static struct tegra_asoc_platform_data tf700_audio_aic326x_pdata = {
	.gpio_spkr_en		= -1,
	.gpio_hp_det		= TEGRA_GPIO_HP_DET,
	.gpio_hp_mute		= -1,
	.gpio_int_mic_en	= -1,
...
static struct platform_device tf700_audio_aic326x_device = {
	.name	= "tegra-snd-aic326x",
	.id	= 0,
	.dev	= {
		.platform_data  = &tf700_audio_aic326x_pdata,
	},
};

static struct platform_device *tf700_devices[] __initdata = {
	&tegra_pmu_device,
	&tegra_rtc_device,
	&tegra_udc_device,
	...
	&baseband_dit_device,
	&tf700_bt_rfkill_device,
	&tegra_pcm_device,
	&tf700_audio_device,
	//&tf700_audio_rt5640_device,
	&tf700_audio_max98095_device,
	&tf700_audio_aic326x_device,
	&tegra_hda_device,
	&tegra_cec_device,
...
static int __init tf700_touch_init(void)
{
...
struct platform_device *tf700_tegra_usb_hsic_host_register(void)
{
...
void tf700_tegra_usb_hsic_host_unregister(struct platform_device *pdev)
{
	platform_device_unregister(pdev);
}

struct platform_device *tf700_tegra_usb_utmip_host_register(void)
{
	struct platform_device *pdev;
	int val;
...
void tf700_tegra_usb_utmip_host_unregister(struct platform_device *pdev)
{
	platform_device_unregister(pdev);
}

#if defined(CONFIG_USB_SUPPORT)
static void tf700_usb_init(void)
{
...
static void tf700_audio_init(void)
{
	struct board_info board_info;
	unsigned int project_id = tegra3_get_project_id();
	if(project_id == TEGRA3_PROJECT_TF500T || project_id == TEGRA3_PROJECT_P1801){
		//tegra_get_board_info(&board_info);
		tf700_audio_rt5640_pdata.codec_name = "rt5640.4-001c";
		tf700_audio_rt5640_pdata.codec_dai_name = "rt5640-aif1";
	}
}
static void tf700_gps_init(void)
{
...
#ifdef CONFIG_PN544_NFC
static void tf700_nfc_init(void)
{
...
static struct tegra_pci_platform_data tf700_pci_platform_data = {
	.port_status[0]	= 1,
	.port_status[1]	= 1,
	.port_status[2]	= 1,
	.use_dock_detect	= 0,
...
static void tf700_pci_init(void)
{
	struct board_info board_info;

	tegra_get_board_info(&board_info);
	if (board_info.board_id == BOARD_E1291) {
		tf700_pci_platform_data.port_status[0] = 0;
		tf700_pci_platform_data.port_status[1] = 0;
		tf700_pci_platform_data.port_status[2] = 1;
		tf700_pci_platform_data.use_dock_detect = 1;
		tf700_pci_platform_data.gpio = DOCK_DETECT_GPIO;
	}
	if ((board_info.board_id == BOARD_E1186) ||
		(board_info.board_id == BOARD_E1187) ||
		(board_info.board_id == BOARD_E1291)) {
		tegra_pci_device.dev.platform_data = &tf700_pci_platform_data;
		platform_device_register(&tegra_pci_device);
	}
}

static void tf700_modem_init(void)
{
	struct board_info board_info;
	...
	case BOARD_PM269:
		...
		&tf700_tegra_usb_hsic_host_register;
		tegra_baseband_power_data.hsic_unregister =
			&tf700_tegra_usb_hsic_host_unregister;
		platform_device_register(&tegra_baseband_power_device);
		platform_device_register(&tegra_baseband_power2_device);
...
static void tf700_sata_init(void)
{
...
static void __init tegra_tf700_init(void)
{
	/* input chip uid for initialization of kernel misc module */
	tf700_misc_init(tegra_chip_uid());
	tegra_thermal_init(&thermal_data,
				throttle_list,
				ARRAY_SIZE(throttle_list));
	tegra_clk_init_from_table(tf700_clk_init_table);
	tf700_pinmux_init();
	tf700_misc_reset();
	tegra_booting_info();
	tf700_i2c_init();
	...
	tf700_uart_init();
	tegra_camera_init();
	platform_add_devices(tf700_devices, ARRAY_SIZE(tf700_devices));
	tegra_ram_console_debug_init();
	tf700_sdhci_init();
	tf700_regulator_init();
	tf700_dtv_init();
	tf700_suspend_init();
	tf700_touch_init();
        tf700_gps_init();
	...
	tf700_sensors_init();
	//tf700_audio_init();
	tf700_setup_bluesleep();
	tf700_sata_init();
	//audio_wired_jack_init();
	tf700_pins_state_init();
	tf700_emc_init();
...
static void __init tegra_tf700_reserve(void)
{
...
MACHINE_START(CARDHU, "tf700")
	.boot_params    = 0x80000100,
	.map_io         = tegra_map_common_io,
	.reserve        = tegra_tf700_reserve,
	.init_early	= tegra_init_early,
	.init_irq       = tegra_init_irq,
	.timer          = &tegra_timer,
	.init_machine   = tegra_tf700_init,
MACHINE_END
