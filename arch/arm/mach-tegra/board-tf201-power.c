...
int __init tf201_regulator_init(void)
{
	...
	if (pmu_board_info.board_id == BOARD_PMU_PM298)
		return tf201_pm298_regulator_init();

	if (pmu_board_info.board_id == BOARD_PMU_PM299)
		return tf201_pm299_regulator_init();
...
int __init tf201_fixed_regulator_init(void)
{
	...
	if (pmu_board_info.board_id == BOARD_PMU_PM298)
		return tf201_pm298_gpio_switch_regulator_init();

	if (pmu_board_info.board_id == BOARD_PMU_PM299)
		return tf201_pm299_gpio_switch_regulator_init();
