...
static const struct tegra_emc_table tf201_emc_tables_h5tc2g[] = {
	{
		0x30,		/* Rev 3.0 */
...
static const struct tegra_emc_table tf201_emc_tables_h5tc2g_a2[] = {
	{
		0x32,       /* Rev 3.2 */
...
static const struct tegra_emc_table tf201_emc_tables_h5tc2g_a2_2GB1R[] = {
	{
		0x32,       /* Rev 3.2 */
		51000,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table tf201_emc_tables_k4b4g0846b_hyk0[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table tf201_emc_tables_k4p8g304eb[] = {
	{
		0x32,       /* Rev 3.2 */
...
static const struct tegra_emc_table tf201_emc_tables_edb8132b2ma[] = {
	{
		0x32,       /* Rev 3.2 */
		25500,      /* SDRAM frequency */
		{
...
static const struct tegra_emc_table tf201_emc_tables_h5tc2g_pm311[] = {
	{
		0x32,       /* Rev 3.2 */
		51000,      /* SDRAM frequency */
		{
...
int tf201_emc_init(void)
{
	...
	if (ret < 0) {
		printk("tf201_emc_init: request MEMORY_BOOSTRAP_PIN_AD4 failed\n");
		WARN_ON(1);
	}

	ret= gpio_direction_input(MEMORY_BOOSTRAP_PIN_AD4);
	if (ret < 0) {
		printk("tf201_emc_init: failed to configure MEMORY_BOOSTRAP_PIN_AD4\n");
		WARN_ON(1);
	}
	...
	if (ret < 0) {
		printk("tf201_emc_init: request MEMORY_BOOSTRAP_PIN_AD5 failed\n");
		WARN_ON(1);
	}
	...
	case BOARD_PM305:
		break;
	case BOARD_PM311:
		tegra_init_emc(tf201_emc_tables_h5tc2g_pm311,
			ARRAY_SIZE(tf201_emc_tables_h5tc2g_pm311));
		break;
	default:
		if (tegra_get_revision() == TEGRA_REVISION_A01)
			tegra_init_emc(tf201_emc_tables_h5tc2g,
				ARRAY_SIZE(tf201_emc_tables_h5tc2g));
		else if (MEMORY_TYPE(board.sku) == SKU_MEMORY_tf201_1GB_1R)
			tegra_init_emc(tf201_emc_tables_h5tc2g_a2,
				ARRAY_SIZE(tf201_emc_tables_h5tc2g_a2));
		else if (MEMORY_TYPE(board.sku) ==
				SKU_MEMORY_tf201_2GB_1R_HYK0)
			tegra_init_emc(tf201_emc_tables_k4b4g0846b_hyk0,
				ARRAY_SIZE(tf201_emc_tables_k4b4g0846b_hyk0));
		else if (MEMORY_TYPE(board.sku) ==
				SKU_MEMORY_tf201_2GB_1R_HYNIX)
			tegra_init_emc(tf201_emc_tables_h5tc2g_a2_2GB1R,
				ARRAY_SIZE(tf201_emc_tables_h5tc2g_a2_2GB1R));
		break;
	}
