...
static struct rfkill_gpio_platform_data tf201_bt_rfkill_pdata[] = {
	{
		.name           = "bt_rfkill",
...
static struct platform_device tf201_bt_rfkill_device = {
	.name = "rfkill_gpio",
	.id             = -1,
	.dev = {
		.platform_data = &tf201_bt_rfkill_pdata,
	},
};
...
static struct tegra_i2c_platform_data tf201_i2c3_platform_data_for_TF300 = {
	.adapter_nr	= 2,
	.bus_count	= 1,
	.bus_clk_rate	= { 400000, 0 },
	.scl_gpio		= {TEGRA_GPIO_PBB1, 0},
...
static struct wm8903_platform_data tf201_wm8903_pdata = {
	.irq_active_low = 0,
	.micdet_cfg = 0,
	.micdet_delay = 100,
	.gpio_base = tf201_GPIO_WM8903(0),
	.gpio_cfg = {
...
static struct i2c_board_info __initdata wm8903_board_info = {
	...
	.platform_data = &tf201_wm8903_pdata,
};
...
static struct max98095_pdata tf201_max98095_pdata = {
...
static struct i2c_board_info __initdata tf201_codec_wm8903_info = {
	I2C_BOARD_INFO("wm8903", 0x1a),
	.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
	.platform_data = &tf201_wm8903_pdata,
};

static struct i2c_board_info __initdata tf201_codec_rt5640_info[] = {
	{
		 I2C_BOARD_INFO("rt5640", 0x1c),
		.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
	},
...
static struct i2c_board_info __initdata tf201_codec_aic326x_info = {
	I2C_BOARD_INFO("aic3262-codec", 0x18),
	.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
};

static struct i2c_board_info __initdata tf201_codec_max98095_info = {
	I2C_BOARD_INFO("max98095", 0x10),
	.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
	.platform_data = &tf201_max98095_pdata,
};
...
static void tf201_i2c_init(void)
{
	...
	if ((project_info == TEGRA3_PROJECT_TF300T) ||
		...
		tegra_i2c_device3.dev.platform_data = &tf201_i2c3_platform_data_for_TF300;
	} else {
	...
	//i2c_register_board_info(4, &tf201_codec_wm8903_info, 1);
	//i2c_register_board_info(4, &tf201_codec_max98095_info, 1);
	//i2c_register_board_info(4, &tf201_codec_aic326x_info, 1);
...
static struct tegra_uart_platform_data tf201_loopback_uart_pdata;
...
static void __init tf201_uart_init(void)
{
	...
	tf201_loopback_uart_pdata.parent_clk_list = uart_parent_clk;
	tf201_loopback_uart_pdata.parent_clk_count =
						ARRAY_SIZE(uart_parent_clk);
	tf201_loopback_uart_pdata.is_loopback = true;
	...
	tegra_uarte_device.dev.platform_data = &tf201_loopback_uart_pdata;
...
static void __init tf201_spi_init(void)
{
	...
	if (board_info.board_id == BOARD_E1198) {
		tegra_spi_device2.dev.platform_data = &tf201_spi_pdata;
		platform_device_register(&tegra_spi_device2);
		tegra_spi_slave_device1.dev.platform_data = &tf201_spi_pdata;
		platform_device_register(&tegra_spi_slave_device1);
	}
}

static void __init tf201_dtv_init(void)
{
...
static struct tegra_wm8903_platform_data tf201_audio_wm8903_pdata = {
...
static struct platform_device tf201_audio_device = {
	.name	= "tegra-snd-codec",
        .id     = 0,
        .dev    = {
                .platform_data = &tf201_audio_wm8903_pdata,
        },
};
static struct tegra_rt5640_platform_data tf201_audio_rt5640_pdata = {
	.gpio_spkr_en		= -1,
	.gpio_hp_det		= TEGRA_GPIO_HP_DET,
	.gpio_hp_mute		= -1,
	.gpio_int_mic_en	= -1,
...
static struct tegra_asoc_platform_data tf201_audio_max98095_pdata = {
	.gpio_spkr_en		= -1,
	.gpio_hp_det		= TEGRA_GPIO_HP_DET,
	.gpio_hp_mute		= -1,
	.gpio_int_mic_en	= -1,
...
static struct platform_device tf201_audio_wm8903_device = {
...
static struct platform_device tf201_audio_rt5640_device = {
	.name	= "tegra-snd-codec",
	.id	= 0,
	.dev	= {
		.platform_data = &tf201_audio_rt5640_pdata,
	},
};

static struct platform_device tf201_audio_max98095_device = {
	.name	= "tegra-snd-max98095",
	.id	= 0,
	.dev	= {
		.platform_data = &tf201_audio_max98095_pdata,
	},
};

static struct tegra_asoc_platform_data tf201_audio_aic326x_pdata = {
	.gpio_spkr_en		= -1,
	.gpio_hp_det		= TEGRA_GPIO_HP_DET,
	.gpio_hp_mute		= -1,
	.gpio_int_mic_en	= -1,
	.gpio_ext_mic_en	= -1,
	/*defaults for Verbier-tf201 board with TI AIC326X codec*/
	.audio_port_id		= {
		[HIFI_CODEC] = 0,
		[BASEBAND] = -1,
		[BT_SCO] = 3,
...
static struct platform_device tf201_audio_aic326x_device = {
	.name	= "tegra-snd-aic326x",
	.id	= 0,
	.dev	= {
		.platform_data  = &tf201_audio_aic326x_pdata,
	},
};
...
static struct platform_device *tf201_devices[] __initdata = {
	...
	&baseband_dit_device,
	&tf201_bt_rfkill_device,
	&tegra_pcm_device,
	&tf201_audio_device,
	//&tf201_audio_rt5640_device,
	&tf201_audio_max98095_device,
	&tf201_audio_aic326x_device,
	&tegra_hda_device,
	&tegra_cec_device,
...
static void tf201_usb_hsic_postsupend(void)
{
...
static void tf201_usb_hsic_preresume(void)
{
#ifdef CONFIG_TEGRA_BB_XMM_POWER
...
static void tf201_usb_hsic_phy_ready(void)
{
#ifdef CONFIG_TEGRA_BB_XMM_POWER
...
static void tf201_usb_hsic_phy_off(void)
{
#ifdef CONFIG_TEGRA_BB_XMM_POWER
...
static struct tegra_usb_phy_platform_ops hsic_xmm_plat_ops = {
	.post_suspend = tf201_usb_hsic_postsupend,
	.pre_resume = tf201_usb_hsic_preresume,
	.port_power = tf201_usb_hsic_phy_ready,
	.post_phy_off = tf201_usb_hsic_phy_off,
};
...
static void tf201_audio_init(void)
{
	struct board_info board_info;
	unsigned int project_id = tegra3_get_project_id();
	if(project_id == TEGRA3_PROJECT_TF500T || project_id == TEGRA3_PROJECT_P1801){
		//tegra_get_board_info(&board_info);
		tf201_audio_rt5640_pdata.codec_name = "rt5640.4-001c";
		tf201_audio_rt5640_pdata.codec_dai_name = "rt5640-aif1";
	}
}
...
static void tf201_pci_init(void)
{
	...
	if (board_info.board_id == BOARD_E1291) {
		tf201_pci_platform_data.port_status[0] = 0;
		tf201_pci_platform_data.port_status[1] = 0;
		tf201_pci_platform_data.port_status[2] = 1;
		tf201_pci_platform_data.use_dock_detect = 1;
		tf201_pci_platform_data.gpio = DOCK_DETECT_GPIO;
	}
	if ((board_info.board_id == BOARD_E1186) ||
...
static void tf201_modem_init(void)
{
	struct board_info board_info;
