/*
 * arch/arm/mach-tegra/board-tf300-pinmux.c
 *
...
static __initdata struct tegra_drive_pingroup_config tf300_drive_pinmux[] = {
...
static __initdata struct tegra_pingroup_config tf300_pinmux_common[] = {
	/* SDMMC1 pinmux */
...
static __initdata struct tegra_pingroup_config tf300_pinmux_e118x[] = {
	/* Power rails GPIO */
	DEFAULT_PINMUX(SPI2_SCK,        SPI2,            NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(GMI_RST_N,       RSVD3,           PULL_UP,   TRISTATE,   INPUT),
};

static __initdata struct tegra_pingroup_config tf300_pinmux_pm311[] = {
	/* Power rails GPIO */
	DEFAULT_PINMUX(SPI2_SCK,        SPI2,            NORMAL,    NORMAL,     INPUT),
...
static __initdata struct tegra_pingroup_config tf300_pinmux_tf300[] = {
	DEFAULT_PINMUX(LCD_CS0_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
...
static __initdata struct tegra_pingroup_config tf300_pinmux_tf300_a03[] = {
	DEFAULT_PINMUX(LCD_CS0_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_SCK,         DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_CS1_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_M1,          DISPLAYA,        NORMAL,    NORMAL,     INPUT),
...
static __initdata struct tegra_pingroup_config tf300_pinmux_e1291_a04[] = {
	DEFAULT_PINMUX(GMI_AD15,        NAND,            PULL_DOWN,   NORMAL,   OUTPUT),
...
static __initdata struct tegra_pingroup_config tf300_pinmux_e1198[] = {
	DEFAULT_PINMUX(LCD_CS0_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_SCK,         DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_CS1_N,       DISPLAYA,        NORMAL,    NORMAL,     INPUT),
	DEFAULT_PINMUX(LCD_M1,          DISPLAYA,        NORMAL,    NORMAL,     INPUT),
...
static __initdata struct tegra_pingroup_config tf300_pinmux_pm269_e1506[] = {
...
static void __init tf300_pinmux_audio_init(void)
{
...
static void __init tf300_gpio_init_configure(void)
{
...
int __init tf300_pinmux_init(void)
{
	struct board_info board_info;
	struct board_info display_board_info;
	u32 project_info = tegra3_get_project_id();

	tf300_gpio_init_configure();

	tegra_pinmux_config_table(tf300_pinmux_common, ARRAY_SIZE(tf300_pinmux_common));
	tegra_drive_pinmux_config_table(tf300_drive_pinmux,
					ARRAY_SIZE(tf300_drive_pinmux));

	tegra_get_board_info(&board_info);
	tegra_get_display_board_info(&display_board_info);
	switch (board_info.board_id) {
	case BOARD_E1198:
		tegra_pinmux_config_table(tf300_pinmux_e1198,
					ARRAY_SIZE(tf300_pinmux_e1198));
		tegra_pinmux_config_table(unused_pins_lowpower,
					ARRAY_SIZE(unused_pins_lowpower));
		if (board_info.fab >= BOARD_FAB_A02)
			tegra_pinmux_config_table(tf300_pinmux_tf300_a03,
					ARRAY_SIZE(tf300_pinmux_tf300_a03));
		break;
	case BOARD_E1291:
		if (board_info.fab < BOARD_FAB_A03) {
			tegra_pinmux_config_table(tf300_pinmux_tf300,
					ARRAY_SIZE(tf300_pinmux_tf300));
			tegra_pinmux_config_table(unused_pins_lowpower,
					ARRAY_SIZE(unused_pins_lowpower));
		} else {
			tegra_pinmux_config_table(tf300_pinmux_tf300_a03,
		...
		if (board_info.fab >= BOARD_FAB_A04)
			tegra_pinmux_config_table(tf300_pinmux_e1291_a04,
					ARRAY_SIZE(tf300_pinmux_e1291_a04));
		break;
	...
	case BOARD_E1257:
		if (board_info.board_id == BOARD_PM311 || board_info.board_id == BOARD_PM305) {
			tegra_pinmux_config_table(tf300_pinmux_pm311,
					ARRAY_SIZE(tf300_pinmux_pm311));
		} else {
			tegra_pinmux_config_table(tf300_pinmux_e118x,
					ARRAY_SIZE(tf300_pinmux_e118x));
		}

		if (display_board_info.board_id == BOARD_DISPLAY_E1506) {
			tegra_pinmux_config_table(tf300_pinmux_pm269_e1506,
					ARRAY_SIZE(tf300_pinmux_pm269_e1506));
		}
...
struct gpio_init_pin_info pin_lpm_tf300_common[] = {
...
struct gpio_init_pin_info pin_lpm_tf300_common_wo_pm313[] = {
 ...
 * recomendation */
int __init tf300_pins_state_init(void)
{
	struct board_info board_info;
	struct board_info display_board_info;
	...
	if ((board_info.board_id == BOARD_E1291) ||
		(board_info.board_id == BOARD_E1198)) {
			set_unused_pin_gpio(&pin_lpm_tf300_common[0],
					ARRAY_SIZE(pin_lpm_tf300_common));

			if (display_board_info.board_id != BOARD_DISPLAY_PM313) {
				set_unused_pin_gpio(&pin_lpm_tf300_common_wo_pm313[0],
						ARRAY_SIZE(pin_lpm_tf300_common_wo_pm313));
			}
	}
