/*
 * arch/arm/mach-tegra/board-tf300.c
 *
...
int __init tf300_misc_init(void);
...
static struct rfkill_gpio_platform_data tf300_bt_rfkill_pdata[] = {
	{
		.name           = "bt_rfkill",
...
static struct platform_device tf300_bt_rfkill_device = {
	.name = "rfkill_gpio",
	.id             = -1,
	.dev = {
		.platform_data = &tf300_bt_rfkill_pdata,
	},
};

static struct resource tf300_bluesleep_resources[] = {
	[0] = {
		.name = "gpio_host_wake",
...
static struct platform_device tf300_bluesleep_device = {
	.name           = "bluesleep",
	.id             = -1,
	.num_resources  = ARRAY_SIZE(tf300_bluesleep_resources),
	.resource       = tf300_bluesleep_resources,
};

static noinline void __init tf300_setup_bluesleep(void)
{
	platform_device_register(&tf300_bluesleep_device);
	return;
}

static __initdata struct tegra_clk_init_table tf300_clk_init_table[] = {
...
static struct i2c_board_info __initdata tf300_i2c_bus3_board_info[] = {
	{
...
static struct tegra_i2c_platform_data tf300_i2c1_platform_data = {
	.adapter_nr	= 0,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data tf300_i2c2_platform_data = {
	.adapter_nr	= 1,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data tf300_i2c3_platform_data = {
	.adapter_nr	= 2,
	.bus_count	= 1,
	.bus_clk_rate	= { 100000, 0 },
...
static struct tegra_i2c_platform_data tf300_i2c3_platform_data_for_TF300 = {
	.adapter_nr	= 2,
	.bus_count	= 1,
	.bus_clk_rate	= { 400000, 0 },
	.scl_gpio		= {TEGRA_GPIO_PBB1, 0},
...
static struct tegra_i2c_platform_data tf300_i2c4_platform_data = {
	.adapter_nr	= 3,
	.bus_count	= 1,
...
static struct tegra_i2c_platform_data tf300_i2c5_platform_data = {
	.adapter_nr	= 4,
	.bus_count	= 1,
	.bus_clk_rate	= { 400000, 0 },
...
static struct wm8903_platform_data tf300_wm8903_pdata = {
	.irq_active_low = 0,
	.micdet_cfg = 0,
	.micdet_delay = 100,
...
static const struct i2c_board_info tf300_dsp_board_info[] = {
	{
...
static struct i2c_board_info __initdata wm8903_board_info = {
	...
	.platform_data = &tf300_wm8903_pdata,
};
...
static struct max98095_pdata tf300_max98095_pdata = {
...
static struct i2c_board_info __initdata tf300_codec_wm8903_info = {
	I2C_BOARD_INFO("wm8903", 0x1a),
	.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
	.platform_data = &tf300_wm8903_pdata,
};

static struct i2c_board_info __initdata tf300_codec_rt5640_info[] = {
	{
		 I2C_BOARD_INFO("rt5640", 0x1c),
		.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
	},
...
static struct i2c_board_info __initdata tf300_codec_aic326x_info = {
	I2C_BOARD_INFO("aic3262-codec", 0x18),
	.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
};

static struct i2c_board_info __initdata tf300_codec_max98095_info = {
	I2C_BOARD_INFO("max98095", 0x10),
	.irq = TEGRA_GPIO_TO_IRQ(TEGRA_GPIO_CDC_IRQ),
	.platform_data = &tf300_max98095_pdata,
};

static struct i2c_board_info __initdata tf300_i2c_asuspec_info[] = {
	{
...
static void tf300_i2c_init(void)
{
	u32 project_info = tegra3_get_project_id();

	tegra_i2c_device1.dev.platform_data = &tf300_i2c1_platform_data;
	tegra_i2c_device2.dev.platform_data = &tf300_i2c2_platform_data;
	...
	if ((project_info == TEGRA3_PROJECT_TF300T) ||
		...
		tegra_i2c_device3.dev.platform_data = &tf300_i2c3_platform_data_for_TF300;
	} else {
		tegra_i2c_device3.dev.platform_data = &tf300_i2c3_platform_data;
	}
	tegra_i2c_device4.dev.platform_data = &tf300_i2c4_platform_data;
	tegra_i2c_device5.dev.platform_data = &tf300_i2c5_platform_data;
	...
	//i2c_register_board_info(4, &tf300_codec_wm8903_info, 1);
	//i2c_register_board_info(4, &tf300_codec_max98095_info, 1);
	//i2c_register_board_info(4, &tf300_codec_aic326x_info, 1);

	i2c_register_board_info(1, tf300_i2c_asuspec_info, ARRAY_SIZE(tf300_i2c_asuspec_info));
	...
	i2c_register_board_info(0, tf300_dsp_board_info, 1);
#endif
}

static struct platform_device *tf300_uart_devices[] __initdata = {
	&tegra_uartb_device,
	&tegra_uartc_device,
	&tegra_uartd_device,
	&tegra_uarte_device,
...
static struct tegra_uart_platform_data tf300_uart_pdata;
static struct tegra_uart_platform_data tf300_loopback_uart_pdata;
...
static void __init tf300_uart_init(void)
{
	struct clk *c;
	int i;
	...
	tf300_uart_pdata.parent_clk_list = uart_parent_clk;
	tf300_uart_pdata.parent_clk_count = ARRAY_SIZE(uart_parent_clk);
	tf300_loopback_uart_pdata.parent_clk_list = uart_parent_clk;
	tf300_loopback_uart_pdata.parent_clk_count =
						ARRAY_SIZE(uart_parent_clk);
	tf300_loopback_uart_pdata.is_loopback = true;
	tegra_uartb_device.dev.platform_data = &tf300_uart_pdata;
	tegra_uartc_device.dev.platform_data = &tf300_uart_pdata;
	tegra_uartd_device.dev.platform_data = &tf300_uart_pdata;
	/* UARTE is used for loopback test purpose */
	tegra_uarte_device.dev.platform_data = &tf300_loopback_uart_pdata;
	...
	platform_add_devices(tf300_uart_devices,
				ARRAY_SIZE(tf300_uart_devices));
}
...
static struct platform_device *tf300_spi_devices[] __initdata = {
	&tegra_spi_device4,
};
...
static struct tegra_spi_platform_data tf300_spi_pdata = {
	.is_dma_based		= true,
...
static void __init tf300_spi_init(void)
{
	int i;
	struct clk *c;
	...
	tf300_spi_pdata.parent_clk_list = spi_parent_clk;
	tf300_spi_pdata.parent_clk_count = ARRAY_SIZE(spi_parent_clk);
	tegra_spi_device4.dev.platform_data = &tf300_spi_pdata;
	platform_add_devices(tf300_spi_devices,
				ARRAY_SIZE(tf300_spi_devices));
	...
	if (board_info.board_id == BOARD_E1198) {
		tegra_spi_device2.dev.platform_data = &tf300_spi_pdata;
		platform_device_register(&tegra_spi_device2);
		tegra_spi_slave_device1.dev.platform_data = &tf300_spi_pdata;
		platform_device_register(&tegra_spi_slave_device1);
	}
}

static void __init tf300_dtv_init(void)
{
...
static struct tegra_wm8903_platform_data tf300_audio_wm8903_pdata = {
...
static struct platform_device tf300_audio_device = {
	.name	= "tegra-snd-codec",
        .id     = 0,
        .dev    = {
                .platform_data = &tf300_audio_wm8903_pdata,
        },
};
static struct tegra_rt5640_platform_data tf300_audio_rt5640_pdata = {
	.gpio_spkr_en		= -1,
	.gpio_hp_det		= TEGRA_GPIO_HP_DET,
	.gpio_hp_mute		= -1,
	.gpio_int_mic_en	= -1,
...
static struct tegra_asoc_platform_data tf300_audio_max98095_pdata = {
	.gpio_spkr_en		= -1,
	.gpio_hp_det		= TEGRA_GPIO_HP_DET,
	.gpio_hp_mute		= -1,
	.gpio_int_mic_en	= -1,
...
static struct platform_device tf300_audio_wm8903_device = {
...
static struct platform_device tf300_audio_rt5640_device = {
	.name	= "tegra-snd-codec",
	.id	= 0,
	.dev	= {
		.platform_data = &tf300_audio_rt5640_pdata,
	},
};

static struct platform_device tf300_audio_max98095_device = {
	.name	= "tegra-snd-max98095",
	.id	= 0,
	.dev	= {
		.platform_data = &tf300_audio_max98095_pdata,
	},
};

static struct tegra_asoc_platform_data tf300_audio_aic326x_pdata = {
	.gpio_spkr_en		= -1,
	.gpio_hp_det		= TEGRA_GPIO_HP_DET,
	.gpio_hp_mute		= -1,
	.gpio_int_mic_en	= -1,
...
static struct platform_device tf300_audio_aic326x_device = {
	.name	= "tegra-snd-aic326x",
	.id	= 0,
	.dev	= {
		.platform_data  = &tf300_audio_aic326x_pdata,
	},
};

static struct platform_device *tf300_devices[] __initdata = {
	&tegra_pmu_device,
	&tegra_rtc_device,
	&tegra_udc_device,
	...
	&baseband_dit_device,
	&tf300_bt_rfkill_device,
	&tegra_pcm_device,
	&tf300_audio_device,
	//&tf300_audio_rt5640_device,
	&tf300_audio_max98095_device,
	&tf300_audio_aic326x_device,
	&tegra_hda_device,
	&tegra_cec_device,
...
static int __init tf300_touch_init(void)
{
...
#if defined(CONFIG_USB_SUPPORT)
static void tf300_usb_init(void)
{
...
static void tf300_audio_init(void)
{
	struct board_info board_info;
	unsigned int project_id = tegra3_get_project_id();
	if(project_id == TEGRA3_PROJECT_TF500T || project_id == TEGRA3_PROJECT_P1801){
		//tegra_get_board_info(&board_info);
		tf300_audio_rt5640_pdata.codec_name = "rt5640.4-001c";
		tf300_audio_rt5640_pdata.codec_dai_name = "rt5640-aif1";
	}
}
static void tf300_gps_init(void)
{
...
#ifdef CONFIG_PN544_NFC
static void tf300_nfc_init(void)
{
...
static struct tegra_pci_platform_data tf300_pci_platform_data = {
	.port_status[0]	= 1,
	.port_status[1]	= 1,
	.port_status[2]	= 1,
	.use_dock_detect	= 0,
...
static void tf300_pci_init(void)
{
	struct board_info board_info;

	tegra_get_board_info(&board_info);
	if (board_info.board_id == BOARD_E1291) {
		tf300_pci_platform_data.port_status[0] = 0;
		tf300_pci_platform_data.port_status[1] = 0;
		tf300_pci_platform_data.port_status[2] = 1;
		tf300_pci_platform_data.use_dock_detect = 1;
		tf300_pci_platform_data.gpio = DOCK_DETECT_GPIO;
	}
	if ((board_info.board_id == BOARD_E1186) ||
		(board_info.board_id == BOARD_E1187) ||
		(board_info.board_id == BOARD_E1291)) {
		tegra_pci_device.dev.platform_data = &tf300_pci_platform_data;
		platform_device_register(&tegra_pci_device);
	}
}

static void tf300_modem_init(void)
{
	struct board_info board_info;
...
static void tf300_sata_init(void)
{
...
static void __init tegra_tf300_init(void)
{
	tegra_thermal_init(&thermal_data,
				throttle_list,
				ARRAY_SIZE(throttle_list));
	tegra_clk_init_from_table(tf300_clk_init_table);
	tf300_pinmux_init();
	tf300_misc_init();
	tegra_booting_info();
	tf300_i2c_init();
...
#endif
	tf300_uart_init();
	platform_add_devices(tf300_devices, ARRAY_SIZE(tf300_devices));
	tegra_ram_console_debug_init();
	tf300_sdhci_init();
	tf300_regulator_init();
	tf300_dtv_init();
	tf300_suspend_init();
	tf300_touch_init();
        tf300_gps_init();
	...
	tf300_sensors_init();
	//tf300_audio_init();
	tf300_setup_bluesleep();
	tf300_sata_init();
	//audio_wired_jack_init();
	tf300_pins_state_init();
	tf300_emc_init();
...
static void __init tegra_tf300_reserve(void)
{
...
MACHINE_START(CARDHU, "tf300")
	.boot_params    = 0x80000100,
	.map_io         = tegra_map_common_io,
	.reserve        = tegra_tf300_reserve,
	.init_early	= tegra_init_early,
	.init_irq       = tegra_init_irq,
	.timer          = &tegra_timer,
	.init_machine   = tegra_tf300_init,
MACHINE_END
