/*
 * arch/arm/mach-tegra/board-tf700.h
 *
...
int tf700_charge_init(void);
int tf700_regulator_init(void);
int tf700_suspend_init(void);
int tf700_sdhci_init(void);
int tf700_pinmux_init(void);
int tf700_panel_init(void);
int tf700_sensors_init(void);
int tf700_keys_init(void);
int tf700_pins_state_init(void);
int tf700_emc_init(void);
int tf700_edp_init(void);
int tf700_pmon_init(void);
int tf700_pm298_gpio_switch_regulator_init(void);
int tf700_pm298_regulator_init(void);
int tf700_pm299_gpio_switch_regulator_init(void);
int tf700_pm299_regulator_init(void);
...
extern struct tegra_uart_platform_data tf700_irda_pdata;
